...
bool PatchedVST3PluginFormat::setStateFromVSTPresetFile (AudioPluginInstance* api, const MemoryBlock& rawData)
{
...
void PatchedVST3PluginFormat::findAllTypesForFile (OwnedArray<PluginDescription>& results, const String& fileOrIdentifier)
{
...
void PatchedVST3PluginFormat::createARAFactoryAsync (const PluginDescription& description, ARAFactoryCreationCallback callback)
{
...
static std::unique_ptr<AudioPluginInstance> createVST3Instance (PatchedVST3PluginFormat& format,
                                                                const PluginDescription& description,
                                                                const File& file)
{
...
StringArray PatchedVST3PluginFormat::getLibraryPaths (const String& fileOrIdentifier)
{
   #if JUCE_WINDOWS
...
void PatchedVST3PluginFormat::createPluginInstance (const PluginDescription& description,
...
bool PatchedVST3PluginFormat::requiresUnblockedMessageThreadDuringCreation (const PluginDescription&) const
{
    return false;
}

bool PatchedVST3PluginFormat::fileMightContainThisPluginType (const String& fileOrIdentifier)
{
...
String PatchedVST3PluginFormat::getNameOfPluginFromIdentifier (const String& fileOrIdentifier)
{
    return fileOrIdentifier; //Impossible to tell because every VST3 is a type of shell...
}

bool PatchedVST3PluginFormat::pluginNeedsRescanning (const PluginDescription& description)
{
    return File (description.fileOrIdentifier).getLastModificationTime() != description.lastFileModTime;
}

bool PatchedVST3PluginFormat::doesPluginStillExist (const PluginDescription& description)
{
    return File (description.fileOrIdentifier).exists();
}

StringArray PatchedVST3PluginFormat::searchPathsForPlugins (const FileSearchPath& directoriesToSearch, const bool recursive, bool)
{
    StringArray results;
...
void PatchedVST3PluginFormat::recursiveFileSearch (StringArray& results, const File& directory, const bool recursive)
{
